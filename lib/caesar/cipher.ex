defmodule Caesar.Cipher do
  ...
  @moduledoc """
  Caesar Cipher module, wich maps charectors to new charectors
  """

  @doc """
  Encrypt the message by applying a mapping that shifts the alphabet be the `shift` value.
  ...
  def calculate_mapping(base_letter, char, shift) do
    # find the ASCII integer of the char and mornalize it
